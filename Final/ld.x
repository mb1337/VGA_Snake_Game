...
/* 
 * Get memory banks definition. This file must be located in 
 * linker directory (search path with -L<dir>). 
...
SECTIONS
{
  ...
  /* Bootloader; high Flash area unbanked  */
  .text_h : 
  {
    *(.text_h)           
    . = ALIGN(2);
  ...
  /* 
   * If the 'vectors_addr' symbol is defined, it indicates the start address of 
   * interrupt vectors.  This depends on the 9S12 operating mode:
   * 
