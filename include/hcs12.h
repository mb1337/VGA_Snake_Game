...
#define  wait_for_interrupts() asm(" wai")
...
#define INTERRUPT ATTR_INT
#define FLAT_FAR  __attribute__((far))

#define BANK0  __attribute__((far,section (".bank0")))
#define BANK1  __attribute__((far,section (".bank1")))
#define BANK2  __attribute__((far,section (".bank2")))
#define BANK3  __attribute__((far,section (".bank3")))
#define BANK4  __attribute__((far,section (".bank4")))
#define BANK5  __attribute__((far,section (".bank5")))
#define BANK6  __attribute__((far,section (".bank6")))
#define BANK7  __attribute__((far,section (".bank7")))
#define BANK8  __attribute__((far,section (".bank8")))
#define BANK9  __attribute__((far,section (".bank9")))
#define BANK10 __attribute__((far,section (".bank10")))
#define BANK11 __attribute__((far,section (".bank11")))
#define BANK12 __attribute__((far,section (".bank12")))
#define BANK13 __attribute__((far,section (".bank13")))
...
/*
 * Some MC689S12DP256 definitions (if you want to use)
 */
#undef RAM_SIZE
...
#define GNU_LINKER_WARNING(SYMBOL, MSG) asm (".section .gnu.warning." SYMBOL "\n\t.string \"" MSG "\"\n\t.previous");
...
#define     PWMPER01     _IO16(0xb4)     //pwm channel 01 period
#define     PWMPER23     _IO16(0xb6)     //pwm channel 23 period
#define     PWMPER45     _IO16(0xb8)     //pwm channel 45 period
#define     PWMPER67     _IO16(0xba)     //pwm channel 67 period
...
#define     PWMDTY4      _IO8(0xc0)     //pwm channel 4 duty cycle
#define     PWMDTY5      _IO8(0xc1)     //pwm channel 5 duty cycle
#define     PWMDTY6      _IO8(0xc2)     //pwm channel 6 duty cycle
#define     PWMDTY7      _IO8(0xc3)     //pwm channel 7 duty cycle
#define     PWMDTY01     _IO16(0xbc)     //pwm channel 01 duty cycle
#define     PWMDTY23     _IO16(0xbe)     //pwm channel 23 duty cycle
#define     PWMDTY45     _IO16(0xc0)     //pwm channel 45 duty cycle
#define     PWMDTY67     _IO16(0xc2)     //pwm channel 67 duty cycle
